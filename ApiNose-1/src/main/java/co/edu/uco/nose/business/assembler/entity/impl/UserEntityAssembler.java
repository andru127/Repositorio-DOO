...
public final class UserEntityAssembler implements EntityAssembler<UserEntity, UserDomain> {
	...
	public UserDomain toDomain(final UserEntity entity) {
		...
		return new UserDomain(entityTmp.getUserId(), identificationTypeDomainTmp, entityTmp.getIdentificationNumber(),
				...
				entityTmp.isEmailConfirmed(), entityTmp.CellPhoneNumberConfirmed());
	}
